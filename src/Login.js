    ...
    <div className="min-h-screen bg-[#1a2634] text-white font-sans">
      ...
      <main className="p-8 max-w-7xl mx-auto">
        <p className="mb-4 text-xl font-medium">
          Student Enrollment For 2nd Semester
        </p>
...
//           className="px-8 py-3 border border-gray-300 text-gray-600 font-semibold rounded-lg hover:bg-gray-100 transition duration-300 ease-in-out"
//         >
//           Go Back
//         </button> */}
//       </div>
